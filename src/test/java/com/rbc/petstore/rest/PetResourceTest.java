...
public class PetResourceTest {
    ...
    public void before() {
        ...
        PetResource petResource = new PetResource(petService,petMapper);
    ...
    private PetDTO getValidPet() {
    	...
    	tags.add(tag);
        PetDTO pet = new PetDTO(null, CNT_PET_NAME, InventoryStatus.AVAILABLE,category,new ArrayList<String>(),tags);
        return pet;
    }
